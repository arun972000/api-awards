...
function createEmailContent(input: ConfirmationEmailInput) {
  ...
  const text = [
    ...
    `The awards ceremony will be held on ${awardDates.ceremony}, ${awardCeremony.time}, at ${awardCeremony.hall}, ${awardCeremony.building}, ${awardCeremony.street}, ${awardCeremony.city}.`,
    '',
      ...
      <tr><td align='center'>
        <table role='presentation' width='100%' cellspacing='0' cellpadding='0' style='max-width:640px;background:#ffffff;border:1px solid #d9dee2;'>
          ...
          <tr><td style='padding:34px;'>
            ...
            <p style='margin:16px 0 0;padding:16px 18px;background:#e9eef2;color:#173b5e;font-size:14px;line-height:1.6;'><strong>Nominations close at ${awardDates.nominationsCloseLong}.</strong><br>The awards ceremony will be held on ${awardDates.ceremony}, ${awardCeremony.time},<br>at ${awardCeremony.hall}, ${awardCeremony.building}, ${awardCeremony.street}, ${awardCeremony.city}.</p>
